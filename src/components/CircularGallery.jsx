...
class App {
  ...
  addEventListeners() {
    ...
    // Wheel and drag-start are scoped to the container (upstream binds these
    // to window, which makes the gallery spin from page scroll anywhere on
    // the site). Move/up stay on window so a drag can finish off-element.
